...
class EncoderForecaster(nn.Module):
    def __init__(self, input_channels, hidden_dim, num_classes=2):
        ...
        """
        self.encoder_1_convlstm = ConvLSTMCell(input_dim=input_channels,
        ...
        self.decoder_1_convlstm = ConvLSTMCell(input_dim=hidden_dim,  # hidden_dim + 1
                                               hidden_dim=hidden_dim,
                                               kernel_size=(3, 3),
                                               bias=True)
